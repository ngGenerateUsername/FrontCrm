...
import { ajoutFournisseur } from "state/Fou_slice/Fou_slice";
...
export default function Overview() {
  ...
  const isErrornomEntreprise = nomFournisseur === "";
  ...
  const EntrepriseFetch = async () => {
    ...
    try {
      ...
      await dispatch(
        ...
        .then((res: any) =>
          history.push("/profile/profile-fournisseur?id=" + res.payload.idUser)
        )
                        ...
                        <Stack direction="column" spacing="20px" w="100%">
                          <FormControl isInvalid={isErrornomEntreprise}>
                            ...
                            {!isErrornomEntreprise ? (
                              <FormErrorMessage>
                                Un Nom de nomFournisseur est requis.
                              </FormErrorMessage>
                            ) : (
                              <FormErrorMessage>
                                Un Nom de nomFournisseur est requis.
